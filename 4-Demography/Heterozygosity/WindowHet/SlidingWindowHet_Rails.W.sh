...
#$ -wd /u/scratch/d/dechavez/rails.project/VCF/Indv/Chr
...
direc=/u/scratch/d/dechavez/rails.project/VCF/Indv/Chr
SCRIPT=/u/home/d/dechavez/project-rwayne/2nd.paper/4-Demography/Heterozygosity/WindowHet/SlidingWindowHet.Rails.py

cd ${direc}

IDX=PseudoChr_W
VCF=$(ls *_chrW_*Mask_Filter.vcf.gz ))

python2.7 ${SCRIPT} ${VCF} 20000 1000 ${IDX}
