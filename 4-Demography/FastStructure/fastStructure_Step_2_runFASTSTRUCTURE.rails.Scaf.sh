...
#$ -l highmem,highp,h_rt=62:00:00,h_data=20G
#$ -N FastStructure
...
calldate=20200727 # date you called genotypes
...
infilePREFIX=LS_joint_allchr_Annot_Mask_Filter_passingSNPs.Scaf.MoreThan2kScaf.vcf
