...
calldate=20200729 # date that genotypes were called
indir=/u/scratch/d/dechavez/rails.project/SNPRelate
# temporary
...
outdir=/u/scratch/d/dechavez/rails.project/SNPRelate${calldate}/plinkFormat 
mkdir -p $outdir
...
plink --vcf $indir/$infile --make-bed --keep-allele-order --const-fid 0 --allow-extra-chr -maf 0.1 -out $outdir/${infile%.vcf.gz}
