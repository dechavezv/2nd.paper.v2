...
cd /u/home/d/dechavez/project-rwayne/SA.VCF/Combined/only_Pass
...
### ${QSUB} -N ROHstep2 ${SCRIPT_DIR}/Step2_run_PLINK_plot.sh bla $(head -n ${SGE_TASK_ID} temp.V2.txt  | tail -n 1)
