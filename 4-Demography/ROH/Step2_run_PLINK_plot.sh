...
#$ -cwd
#$ -l h_rt=14:00:00,h_data=8G,highp,h_vmem=30G
#$ -N runROHstep2
...
FILE=SA.${i}.HQsites.Only.rmDotGenotypes.rmBadVars.Plink
...
head -n1 SA.01.HQsites.Only.rmDotGenotypes.rmBadVars.Plink.out.hom  > catted/SAcanids.catted.hom
