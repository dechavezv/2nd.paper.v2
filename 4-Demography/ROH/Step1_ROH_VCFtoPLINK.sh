...
vcf=SA_chr${i}_TrimAlt_Annot_Mask_Filter_passingSNPs.vcf.gz
...
vcftools --gzvcf $vcf --plink --chr chr$i --out $plinkindir/SA.${i}.HQsites.Only.rmDotGenotypes.rmBadVars.Plink
