...
zcat IRNP_44_joint_chr$(printf %02d $SGE_TASK_ID)_TrimAlt_Annot_VEP_Masked_Filter.vcf.gz | grep -v "FAIL\|WARN\|CpG" | ${VCFTOOLS_DIR}/vcftools --vcf - --LROH --chr chr$(printf %02d $SGE_TASK_ID) --out IRNP_44_joint_chr$(printf %02d $SGE_TASK_ID)_TrimAlt_Annot_VEP_Masked_Filter.vcf.gz
