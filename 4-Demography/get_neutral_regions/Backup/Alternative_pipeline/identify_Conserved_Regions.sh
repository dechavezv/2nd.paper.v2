...
#$ -o /u/project/rwayne/snigenda/finwhale/reports/Alt_Blast_to_zebrafish.out.txt
#$ -e /u/project/rwayne/snigenda/finwhale/reports/Alt_Blast_to_zebrafish.err.txt
#$ -pe shared 4
#$ -m abe
...
mkdir -p ${WORKDIR}/GC_Content/Alternative
...
bedtools getfasta -fi ${REFERENCE} -bed ${WORKDIR}/get_fasta/Alternative/Alt_min10kb_DistFromExons_noCpGIsland_noRepeat_mergedMaxDistance10_sorted.bed -fo ${WORKDIR}/get_fasta/Alternative/Alt_min10kb_DistFromExons_noCpGIsland_noRepeat.fasta
...
perl ${getGC} ${WORKDIR}/get_fasta/Alternative/Alt_min10kb_DistFromExons_noCpGIsland_noRepeat.fasta > ${WORKDIR}/GC_Content/Alternative/Alt_min10kb_DistFromExons_noCpGIsland_noRepeat_GCcontent.txt
...
${BLAST}/bin/blastn -query ${WORKDIR}/get_fasta/Alternative/Alt_min10kb_DistFromExons_noCpGIsland_noRepeat.fasta -db ${ZFISHDIR}/Dare_blastdb -outfmt 7 -num_threads 4 > ${WORKDIR}/zebra_fish/Alternative/Alt_neutralRegions_Blast_ZebraFish_blastn.out
...
cd ${WORKDIR}/zebra_fish/Alternative
grep -v "#"  ${WORKDIR}/zebra_fish/Alternative/Alt_neutralRegions_Blast_ZebraFish_blastn.out | awk '{if($11<1e-10)print $1}' | awk -F"[:-]" '{OFS="\t"; print $1,$2,$3}' | sort | uniq > ${WORKDIR}/zebra_fish/Alternative/Alt_fish.matches.eval.1e-10.0based.bed
