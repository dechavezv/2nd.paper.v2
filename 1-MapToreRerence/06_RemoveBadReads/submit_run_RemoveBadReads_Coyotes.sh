...
#$ -N subbamfltr
#$ -o /u/scratch/d/dechavez/Coyotes/log/reportsfilter.out
#$ -e /u/scratch/d/dechavez/Coyotes/log/reportsfilter.err
#$ -m abe
#$ -M dechavezv
...
${QSUB} -N bamfiltr $SCRIPT_DIR/run_RemoveBadReads_Coyotes.sh ${file}
done
