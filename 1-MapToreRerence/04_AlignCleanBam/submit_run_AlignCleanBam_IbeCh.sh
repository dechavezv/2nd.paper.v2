...
#$ -N subAlign
#$ -o /u/scratch/d/dechavez/IberianChinese/log/BWA
#$ -e /u/scratch/d/dechavez/IberianChinese/log/BWA
#$ -m abe
#$ -M dechavezv
...
export Direc=/u/scratch/d/dechavez/IberianChinese

cd ${Direc}

for i in *MarkIlluminaAdapters.bam; do
	FILENAME=${i%_MarkIlluminaAdapters.bam}
	$QSUB $SCRIPTDIR/run_AlignCleanBam_IbeCh.sh ${FILENAME}
done
