...
#$ -l highmem,h_rt=28:00:00,h_data=8G,highp,h_vmem=40G
#$ -o /u/scratch/d/dechavez/Coyotes/log/AlignClean.err
#$ -e /u/scratch/d/dechavez/Coyotes/log/AlignClean.err
#$ -pe shared 4
#$ -m abe
#$ -M dechavezv
#$ -N Align
...
TEMP_DIR=/u/scratch/d/dechavez/Coyotes/temp/${FILENAME}
