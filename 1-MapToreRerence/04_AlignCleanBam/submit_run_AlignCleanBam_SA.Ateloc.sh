...
#$ -N subAlign
#$ -o /u/scratch/d/dechavez/QB3ateloc/log/BWA
#$ -e /u/scratch/d/dechavez/QB3ateloc/log/BWA
#$ -m abe
#$ -M dechavezv
...
export Direc=/u/scratch/d/dechavez/QB3ateloc

cd ${Direc}

for i in *MarkIlluminaAdapters.bam; do
	FILENAME=${i%_MarkIlluminaAdapters.bam}
	$QSUB $SCRIPTDIR/run_AlignCleanBam_SA.Ateloc.sh ${FILENAME}
	#sleep 3h
done
