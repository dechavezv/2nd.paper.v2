...
#$ -o /u/scratch/d/dechavez/IberianChinese/log/FastqToSam.out
#$ -e /u/scratch/d/dechavez/IberianChinese/log/FastqToSam.err
#$ -m abe
#$ -M dechavezv
#$ -N fq2sam
...
mkdir /u/scratch/d/dechavez/IberianChinese/temp/${2%.*}
TEMP_DIR=/u/scratch/d/dechavez/IberianChinese/temp/${2%.*}
