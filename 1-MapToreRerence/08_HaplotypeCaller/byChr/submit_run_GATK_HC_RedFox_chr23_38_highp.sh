...
for i in {23..38}; 
	...
	do (
	echo "#! /bin/bash"
	echo "#$ -wd /u/home/d/dechavez/project-rwayne/red.fox"
	echo "#$ -l h_vmem=30G,h_rt=24:00:00,h_data=16G,arch=intel*"
	echo "#$ -N HC_Vulp_${i}"
	echo "#$ -o /u/home/d/dechavez/project-rwayne/red.fox/log/"
	echo "#$ -e /u/home/d/dechavez/project-rwayne/red.fox/log/"
	echo "#$ -m abe"
	echo "#$ -M dechavezv"
	echo
	...
	echo
	echo "cd /u/home/d/dechavez/project-rwayne/red.fox"
	echo
	echo "export BAM=SRR5328113_Aligned.MarkDup_Filtered.bam"
	...
	echo "-L chr${i} \\"
	echo "-I \${BAM} \\"
	echo "-o /u/scratch/d/dechavez/red.fox/GVCF/\${ID}_chr${i}.g.vcf.gz"
	
	) > "run_GATK_HC_RedFox_chr23_38_highp.sh"

	qsub run_GATK_HC_RedFox_chr23_38_highp.sh
